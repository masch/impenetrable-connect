...
(Previously: zzz_service_date: z.date())
...
### Requirement: zzz_service_date

(Reason: Replaced by zzz_service_at with full ISO datetime and timezone for proper timezone handling)
